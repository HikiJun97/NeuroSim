...
class TestNetwork:
    ...
    def test_simple_build(self):
        ...
        quant_model = QuantLeNet(
            quant_desc_input=input_desc, quant_desc_weight=weight_desc
        )

        input_desc = QuantDescriptor(amax=6.0)
        weight_desc = QuantDescriptor(amax=1.0)
        quant_model = QuantLeNet(
            quant_desc_input=input_desc, quant_desc_weight=weight_desc
        )
    ...
    def test_asp(self):
        ...
        ASP.init_model_for_pruning(
            ...
            whitelist=[
                ...
                torch.nn.Conv2d,
                torch.nn.Conv3d,
                quant_nn.modules.quant_linear.QuantLinear,
            ],
